...
print("-----------------Tic Ta Toe тоглоомд тавтай мори------------------")
print('--------------------------Role------------------------------------')
print('******************************************************************')
print('* Сонгосон тэмдэгтээ 3 дарааллуулан байрлуулах                   *')
print('* 1-ээс 9-ийн хооронд утга Баруун доод буланд 9 х?ртэлх байрлана.*')
print('З??н дээд булан 1-ээс эхлэн Баруун доод булан 9 х?ртэлх байрлана.*')
print('*****************************************')
print(' Доор гарч ирэх хувилбараас сонголт хийнэ ??:'    )
print('--------------------------------------------')
                ...
                if player1 == 'x' or player1 =='o':
                    ...
                    while check_emptyspaces() == True:
                        ...
                        if vs == 1 :
                            ...
                            if check_wins(player2) == True :
                                print ('Тоглогч ', player2 , 'хожлоо !!!1')
                                break
